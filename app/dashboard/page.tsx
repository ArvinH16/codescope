...
import { GitBranch, GitCommit, Users, Code2, Sparkles, TrendingUp, Activity, MessageSquare, Send } from 'lucide-react'
...
export default function DashboardPage() {
  ...
  const [chatMessages, setChatMessages] = useState<Array<{ role: 'user' | 'assistant', content: string }>>([
    { role: 'assistant', content: 'Hi! I\'m your AI assistant. Ask me anything about your repository activity, code patterns, or contributor insights.' }
  ])
  ...
  const handleSendMessage = () => {
    ...
    const newMessages = [
      ...
      { role: 'assistant' as const, content: 'Based on recent commits, I can see increased activity in the authentication module. Would you like me to analyze specific contributors or code patterns?' }
    ]
        ...
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">main-repository</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
